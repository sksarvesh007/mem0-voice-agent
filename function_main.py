...
async def entrypoint(ctx: JobContext):
    ...
    initial_ctx = llm.ChatContext().append(
        ...
        text=(
            """
            You are a car sales cold caller named Alex from Bubsy Motors.
            ...
            Current promotion: "Summer Clearance Event with 0% financing for 72 months on select models"
    ...
    await agent.say(
        "Hello! This is Alex calling from Bubsy Motors. We're currently running our Summer Clearance Event with 0% financing for 72 months on select models. I was wondering if you might be interested in scheduling a test drive this week?",
